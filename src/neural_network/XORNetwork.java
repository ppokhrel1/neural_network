...
public class XORNetwork {
	public static final int MAX_EPOCHS = 905000;
	//weights
	private static double w13, w23, w14, w24, w35, w45;
	public static double theta3, theta4, theta5;
	...
	public static void main(String[] args){
		...
		while(loop){
			...
			if (epochs >= MAX_EPOCHS){
				System.out.println("Learning will take more than "+MAX_EPOCHS+" epochs.");
				System.exit(0);
			}
			...
			if (sumSqrError < 0.001){
				loop = false;
				System.out.println("The function has successfully been learned.");
			}
